      ...
      <div class="footer-content">
        ...
        <div class="footer-content-column">
          <div class="footer-call-to-action">
            <h2 class="footer-call-to-action-title"> Send an Email</h2>
            <p class="footer-call-to-action-link-wrapper"> <a class="footer-call-to-action-link" href="mailto:ikitab@example.com" target="_self"> ikitab@example.com </a></p>
          </div>
          <div class="footer-call-to-action">
      ...
      <div class="footer-copyright">
        <div class="footer-copyright-wrapper">
          <p class="footer-copyright-text">
            <a class="footer-copyright-link" href="#" target="_self"> ©2022 |iKitab | All rights reserved. </a>
          </p>
        </div>
      </div>
    </footer>
